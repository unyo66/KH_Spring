...
<head>
    ...
    <script async src="./js/iframe_api.js"></script>
    <script async src="./js/index.js"></script>
    <title>Filmap</title>
    <style>
        #L_btn0,#R_btn0 {top: 330px;}
        #L_btn1,#R_btn1 {top: 830px;}
        #L_btn2,#R_btn2 {top: 1355px;}
        #L_btn3,#R_btn3 {top: 1880px;}
        #L_btn4,#R_btn4 {top: 2400px;}
        #L_btn5,#R_btn5 {top: 2950px;}
        .m_img:hover {transition: 0.3s;  transform: scale(1.2);}
        .n_img:hover {transition: 0.3s;  transform: scale(1.2);}
        .wv_img:hover {transition: 0.3s;  transform: scale(1.2);}
        .wc_img:hover {transition: 0.3s;  transform: scale(1.2);}
        .tv_img:hover {transition: 0.3s;  transform: scale(1.2);}
        .d_img:hover {transition: 0.3s;  transform: scale(1.2);}
    </style>
</head>
...
<%--    let tmpArr1 = new Array(15);--%>
<%--    for (let i = 0; i < tmpArr1.length; i++) {--%>
<%--        tmpArr1[i] = "${main.get(i).movie_title}";--%>
<%--        console.log(i + "번째 영화 제목 : " + tmpArr1[i]);--%>
<%--    }--%>
<%--    let el_wrap = document.getElementById("wrap");--%>
<%--    el_wrap.style.cssText = "background: rgb(33, 33, 33);width: 100vw; height: 3700px;  position: absolute; top: -100px";--%>
<%--    // -----------------------------------wrap--%>
...
<%--    el_video_box.style.cssText = "widht: 100vw; height: 1000px;";--%>
...
<%--    el_mute_button.style.cssText = "width: 48px; height: 45px; border-radius: 50%; position: absolute; z-index: 9; top: 700px; left: 1600px;"--%>
...
<%--        el_main_slide_li2.innerText = "${main.get(j).movie_title}";--%>
<%--        // 제목디비--%>
...
<%--        let tmpArr = new Array(15);--%>
<%--        tmpArr[0] = "${main.get(0).movie_title}";--%>
<%--        tmpArr[1] = "${main.get(1).movie_title}";--%>
<%--        tmpArr[2] = "${main.get(2).movie_title}";--%>
<%--        tmpArr[3] = "${main.get(3).movie_title}";--%>
<%--        tmpArr[4] = "${main.get(4).movie_title}";--%>
<%--        tmpArr[5] = "${main.get(5).movie_title}";--%>
<%--        tmpArr[6] = "${main.get(6).movie_title}";--%>
<%--        tmpArr[7] = "${main.get(7).movie_title}";--%>
<%--        tmpArr[8] = "${main.get(8).movie_title}";--%>
<%--        tmpArr[9] = "${main.get(9).movie_title}";--%>
<%--        console.log(j + "번째 영화 제목 : " + tmpArr[j]);--%>
...
<%--        el_main_slide_li2.classList.add("main_slide_li2");--%>
<%--        el_main_slide_li2.setAttribute('id', 'slide_l2');--%>
<%--        el_main_slide_li2.innerText = "${main.get(j + 5).movie_title}";--%>
<%--        // 제목디비--%>
<%--        el_main_slide_li2.style.cssText = "line-height: 50px; text-align: center; color: white;"--%>
...
<%--        el_main_slide_li2.classList.add("main_slide_li2");--%>
<%--        el_main_slide_li2.setAttribute('id', 'slide_l2');--%>
<%--        el_main_slide_li2.innerText = "${main.get(j + 10).movie_title}";--%>
<%--        // 제목디비--%>
<%--        el_main_slide_li2.style.cssText = "line-height: 50px; text-align: center; color: white;"--%>
...
<%--        m_img_li.setAttribute('src', "${main.get(i).movie_img}");--%>
...
<%--    for(let i = 0; i < 5; i++) {--%>
<%--        let m_img_li = document.createElement('img');--%>
<%--        m_img_li.setAttribute('src', 'https://img1.daumcdn.net/thumb/C408x596/?fname=https%3A%2F%2Ft1.daumcdn.net%2Fmovie%2F4899f10a714f3b1cb5bf9569f84e96df0020d414');--%>
<%--        m_img_li.style.cssText = 'width: 200px; height: 300px; object-fit: cover';--%>
<%--        m_img_li.classList.add('class', 'm_img');--%>
<%--        document.getElementById('m_slide_li'+i).append(m_img_li);--%>
...
<%--        n_img_li.setAttribute('src', 'https://img1.daumcdn.net/thumb/C408x596/?fname=https%3A%2F%2Ft1.daumcdn.net%2Fmovie%2F4899f10a714f3b1cb5bf9569f84e96df0020d414');--%>
...
<%--        wv_img_li.setAttribute('src', 'https://img1.daumcdn.net/thumb/C408x596/?fname=https%3A%2F%2Ft1.daumcdn.net%2Fmovie%2F4899f10a714f3b1cb5bf9569f84e96df0020d414');--%>
...
<%--        wc_img_li.setAttribute('src', 'https://img1.daumcdn.net/thumb/C408x596/?fname=https%3A%2F%2Ft1.daumcdn.net%2Fmovie%2F4899f10a714f3b1cb5bf9569f84e96df0020d414');--%>
...
<%--        tv_img_li.setAttribute('src', 'https://img1.daumcdn.net/thumb/C408x596/?fname=https%3A%2F%2Ft1.daumcdn.net%2Fmovie%2F4899f10a714f3b1cb5bf9569f84e96df0020d414');--%>
...
<%--        d_img_li.setAttribute('src', 'https://img1.daumcdn.net/thumb/C408x596/?fname=https%3A%2F%2Ft1.daumcdn.net%2Fmovie%2F4899f10a714f3b1cb5bf9569f84e96df0020d414');--%>
...
<%--    const id_arr = ["jINCabeVFAQ", "jsu9KYYG3og", "7MjKspiRQ-g", "K4KR4J-yBMw", "kihrFxwdMb4"];--%>
<%--    let ran_num = Math.floor(Math.random() * id_arr.length);--%>
<%--    let player;--%>
